...
import com.banking.account.common.events.FundsWirhdrawnEvent;
import com.banking.cqrs.core.dommain.AggregateRoot;
...
public class AccountAggregate extends AggregateRoot {
    ...
    public void withdrawFunds(double amount){
        ...
        raiseEvent(FundsWirhdrawnEvent.builder()
                .id(this.id)
                .amount(amount)
                .build());
    }

    public void apply(FundsWirhdrawnEvent event){
        this.id = event.getId();
        this.balance -= event.getAmount();
    }
